...
- Transport: stdio (Claude Desktop compatible). Streamable HTTP planned for remote deployments.

---

## What We Will NOT Do

- Support authentication methods other than API key (until Streamable HTTP introduces OAuth 2.1).
